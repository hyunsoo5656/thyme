 ...
 */
///Users/gimhyeonsu/Desktop/프로젝트/라즈베리파이/thyme/tas_tem/app.js
...
function timer_upload_action() {
    ...
    shell.exec(cmd, function (error, stdout, stderr) {
        ...
        var dust = stdout.split(',');

        var a = ',' + dust[0] + ',' + dust[1] + ',' + dust[2] + ','
...
//             if (upload_arr[i].id == 'timer') {
//                 var cin = {ctname: upload_arr[i].ctname, con: con};
//                 console.log("timer_upload_action[" +JSON.stringify(cin) + '] ---->');
//                 upload_client.write(JSON.stringify(cin) + '<EOF>');
//                 break;
//             }
//         }
...
function saveLastestData(data) {
    ...
    if(g_sink_buf_start == 0) {
       ...
       /*CO2 ��� ����
            SEND(4����Ʈ) : 0x11, 0x01, 0x01, 0xED
            Respond(8����Ʈ) : 0x16, 0x05, 0x01, 0x02, 0x72, 0x01, 0xD6, 0x99
            ������ 0x16, 0x05, 0x01 �� �׻� ���� ���� ������, ������ �۾��� 0x02, 0x72 �� �󵵸� ��Ÿ���� ��ġ�Դϴ�.
            (HEX) 0x0272 = 626
            ��, �󵵴� 626 ppm �Դϴ�. */
